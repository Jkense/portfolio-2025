...
[Leapfrog](https://leapfrogapp.com) is user research tooling that helps user researcher and user research teams distill insights from qualitative data, like user interviews. By combining the grounded theory method with artificial intelligence, users can analyze their data at mass.
...
With that in mind, I started building Leapfrog. I wanted to create a tool that would help user researchers and user research teams distill insights from qualitative data, like user interviews. By combining the grounded theory method with artificial intelligence, users can analyze their data at mass.
