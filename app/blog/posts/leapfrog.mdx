...
<Bookmark label="AI product strategy" section="design" domains="Product strategy, Research tooling, AI opportunity framing" />
...
<Bookmark label="Research workflows" section="design" domains="Interaction design, Systems design, Research operations" />
...
<Bookmark label="Full-stack architecture" section="engineering" domains="Full-stack system, Real-time collaboration, AI pipeline" />
...
<Bookmark label="System design" section="engineering" domains="Backend workflows, Webhooks, Retrieval, LLM integration" />
...
<Bookmark label="Rapid prototyping" section="engineering" domains="Rapid iteration, Product validation, AI UX" />
