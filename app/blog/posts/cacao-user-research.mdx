...
priority: 0
client: "chemistry"
shortTitle: "healthcare transformation"
timeline: "Sep 2023 - Sep 2024"
team: "Jasper Kense, 3 Chemistry team members, cacao engineering team"
role: "User researcher, Product designer"
skills: "User research, UX design, Healthcare domain knowledge, Stakeholder interviews"
references: "website:https://www.cacao.care,Organization:https://www.chemistryxl.com"
---


<Image
  src="/cacao/cacao.png"
  alt="The website of cacao"
  caption="This project is under NDA. Some details have been omitted to respect that."
  width={1200}
  height={800}
/>
...
<Bookmark label="Healthcare systems" section="design" domains="Healthcare domain knowledge, Systems thinking, Product framing" />
...
<Bookmark label="Care journey research" section="design" domains="User research, Service design, Healthcare UX" />

### 1. Research-Driven Pitch Development

<Bookmark label="Product storytelling" section="design" domains="Pitch strategy, Product storytelling, Stakeholder alignment" />
...
<Bookmark label="Agile delivery" section="engineering" domains="Front-end handoff, Agile delivery, Product systems" />
...
<Bookmark label="Design systems" section="engineering" domains="Design systems, Scalable UX, Product handoff" />
