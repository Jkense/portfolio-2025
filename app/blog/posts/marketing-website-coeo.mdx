...
<Bookmark label="Brand architecture" section="design" domains="Brand design, Information architecture, UX writing" />
...
<Bookmark label="Brand design" section="design" domains="Brand design, Responsive UX, Accessibility" />
...
<Bookmark label="AI integration" section="engineering" domains="AI implementation, Front-end integration, Product experimentation" />
