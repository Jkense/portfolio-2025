...
The payment portal redesign for coeo incasso was a six-month project focused on transforming how people interact with debt collection services online. This project is a direct continuation of my thesis work on inclusive debt collection processes, translating the research and insights from that work into a practical, accessible digital experience that serves everyone—from those who can pay immediately to those who need support navigating their financial situation.
...
The original payment portal suffered from several critical issues that prevented users from successfully resolving their debts:

**Cognitive overload**: The interface presented too many options at once, making it difficult for users to understand their next step. Legal terminology and complex instructions created confusion, especially for users with lower financial literacy or those experiencing stress.

**Lack of guidance**: Users who couldn't pay in full had no clear path forward. The portal didn't explain payment plan options, eligibility criteria, or how to request assistance. This led to abandonment and delayed engagement.

**Missing support connections**: While coeo worked with schuldhulpinstanties (debt assistance agencies) and support organizations, these connections were buried in the portal. Users who needed help didn't know where to find it.

**Accessibility barriers**: The interface wasn't designed with vulnerable groups in mind. Small text, poor contrast, complex forms, and lack of clear error messages created additional friction for users already under stress.

**Internal misalignment**: Different departments (operations, legal, customer support) had different understandings of what the portal should do, leading to inconsistent experiences and missed opportunities for improvement.
...
Understanding the user perspective was critical. I conducted interviews with:

**Recent portal users**: People who had used the portal in the past six months, both successfully and unsuccessfully. I learned about their mental models, expectations, and where they got stuck. Many shared that they felt overwhelmed by the amount of information presented at once.

**Organizations supporting people in debt**: I partnered with MEE Rotterdam Rijnmond and other support organizations to understand the broader context. These organizations work directly with vulnerable groups—people with intellectual disabilities, low literacy, language barriers, or complex financial situations. They helped me understand the real-world constraints and needs of our users.

**Debt assistance agencies (schuldhulpinstanties)**: I interviewed caseworkers to understand how they interact with debt collection portals on behalf of their clients. This revealed opportunities for better integration and clearer communication pathways.

### Key Research Insights

Several patterns emerged from my research:

1. **Users want to resolve their situation**: Most people who arrive at the portal want to take action, but they need clear guidance on what that action should be.

2. **One clear path beats multiple options**: When users see too many choices, they freeze. A guided flow that asks "What do you want to do?" and then provides one clear path forward reduces abandonment.

3. **Support should be visible, not hidden**: Users who need help should be able to find it immediately, not after clicking through multiple pages.

4. **Language matters**: Plain language, empathetic tone, and clear explanations build trust and reduce anxiety. Legal jargon creates barriers.

5. **Contextual help beats help pages**: Users need information at the moment of decision, not in a separate help section they may never find.

## Design Process

### Collaborative Ideation in Figma

I used Figma as my primary collaboration tool, creating a shared workspace where team members from different departments could view, comment on, and contribute to designs in real-time. This approach had several advantages:

**Rapid iteration**: I could quickly explore multiple directions, test different flows, and discard ideas that didn't work without investing significant development time.

**Cross-functional feedback**: Operations, legal, and support staff could see designs as they evolved, providing feedback early and often. This prevented the "surprise reveal" moment and built buy-in throughout the process.

**Visual communication**: For stakeholders who weren't familiar with UX terminology, visual prototypes made it easier to understand and discuss design decisions.

**Version control**: Figma's version history allowed me to track how designs evolved and revisit earlier concepts when needed.
...
Based on my research, I established clear design principles that guided every decision:

1. **Make the next step unmistakable**: Every screen should have one clear primary action. Users should never have to guess what to do next.

2. **Reduce cognitive load**: Break complex processes into small, manageable steps. Use progressive disclosure to show information only when needed.

3. **Provide support at decision points**: When users face a choice, offer help right there—don't make them search for it.

4. **Use plain language at B1 level**: I committed to writing all content at B1 language level (intermediate Dutch), ensuring readability for users with varying language proficiency. This wasn't just a guideline—it was a hard requirement. Every piece of text was tested for readability, and I simplified language even when it meant challenging legal conventions.

5. **Preserve user agency**: Give users control over their choices while providing clear guidance. Don't force them down a single path, but make the recommended path obvious.

6. **Design for vulnerable users**: If the portal works for users with low literacy, language barriers, or cognitive disabilities, it will work for everyone.

### Flow Design

I mapped out the entire user journey, identifying decision points and support opportunities. The portal needed to support four primary use cases:

**Direct payment flow**: For users ready to pay the full amount immediately, I streamlined the process to minimize steps while maintaining security. Clear progress indicators and confirmation screens reduce anxiety and provide reassurance throughout the payment process.

**Payment plan flow**: For debtors who need to pay in installments, this was the most complex flow. I broke it down into clear steps: eligibility check, plan calculator, review, and confirmation. At each step, I provided clear explanations and support options. The ultimate goal was to enable full customization and personalization of payment plans, allowing users to choose their preferred payment date and adjust amounts based on their financial situation.

**Objection flow**: For those who dispute the debt, I designed a flow that allows users to request an objection and provides them with the necessary information to do so. This flow guides users through the objection process with clear explanations of their rights and the steps required.

**Support flow**: Users who need help can access it from anywhere in the portal. I designed multiple entry points—prominent buttons, contextual help, and direct connections to schuldhulpinstanties. This ensures that support is always accessible, not hidden behind multiple clicks.

### Prototyping & Iteration

I created multiple rounds of prototypes, each addressing feedback from the previous round:

**Low-fidelity wireframes**: I started with simple sketches and wireframes to test flow logic and information architecture. These were quick to create and easy to modify based on feedback.

**Interactive prototypes**: Using Figma's prototyping features, I created clickable prototypes that stakeholders could actually use. This helped identify usability issues before development began.
...
The portal starts with a simple question: "What would you like to do?" Users choose from clear options that route them to the appropriate flow:

- Pay now (direct payment)
- Set up a payment plan (for installments)
- Dispute the debt (objection flow)
- Get help or information (support flow)

This initial routing reduces cognitive load and directs users to the appropriate flow immediately. The language is simple and action-oriented, avoiding jargon or legal terminology.
